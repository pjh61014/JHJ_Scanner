...
public class ScannerDAOImpl implements ScannerDAO {
	...
	public String scanResults(scanDTO results) {
		...
		// System.out.println("[DAO][scaninfo] url: " + scan.getUrl() + "date: "
		// + scan.getDate());
		// System.out.println("[DAO][forminfo] form_name: " +
		// form.getForm_name() + " tagid: " + form.getTagid());
	...
	@Override
	public scanInfoDTO findResults(String resultid) {
		// sqlinjection2
